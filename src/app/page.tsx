...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col bg-black">
      {/* 1. 原始版 Hero Section：轮播图在底层，文字浮在上面 */}
        ...
        <div className="relative z-10 container px-4 md:px-6 flex flex-col items-center text-center">
          <div className="max-w-4xl space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
            ...
            <div className="flex flex-col sm:flex-row gap-6 pt-4 justify-center">
              <Link href="/products" className="inline-flex h-14 items-center justify-center rounded-full bg-[#c5a47e] px-10 text-sm font-black text-black shadow-[0_0_30px_rgba(197,164,126,0.3)] hover:scale-105 transition-all uppercase tracking-widest">Shop Now</Link>
              <Link href="/contact" className="inline-flex h-14 items-center justify-center rounded-full border border-white/20 bg-white/5 backdrop-blur-sm px-10 text-sm font-bold text-white transition-all hover:bg-white hover:text-black uppercase tracking-widest">Learn More</Link>
            </div>
          </div>
        </div>
      </section>
