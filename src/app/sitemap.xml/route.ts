...
export async function GET() {
  const staticPages = [
    ...
    xmlUrl(`${siteUrl}/products/security-camera-kits`, siteLastModified, ["/img/products/dahua-2-camera-kit/dahua-2-camera-kit-poster-v1.png", "/img/products/dahua-2-camera-kit/dahua-nvr4104hs-p-4ks2-l.webp"]),
