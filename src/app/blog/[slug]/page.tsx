  ...
  return (
    <article className="min-h-screen bg-zinc-950 pt-32 pb-20">
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-10 leading-[1.1]">
          {data.title}
        </h1>
        ...
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-3xl p-8 mb-12 flex items-start gap-4">
            ...
            <div>
                ...
                <p className="text-zinc-500 text-sm font-light leading-relaxed">This project was completed by John and the ADE team in South Australia. All images and technical descriptions represent actual field work.</p>
            </div>
        </div>
        ...
        <div className="mt-20 p-10 rounded-3xl bg-zinc-900 border border-zinc-800 text-center relative overflow-hidden">
          ...
          <h3 className="text-2xl font-bold text-white mb-4">Need a similar installation?</h3>
          <p className="text-zinc-500 mb-8 max-w-md mx-auto text-sm font-light">Get in touch for a free site assessment and quote for your home in Adelaide.</p>
